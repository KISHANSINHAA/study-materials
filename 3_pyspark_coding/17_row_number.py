...
# PySpark Row Number Window Function
...
spark = SparkSession.builder.appName("RowNumber").master("local[*]").getOrCreate()
df = spark.createDataFrame([("A", 10), ("A", 20), ("B", 30)], ["Category", "Value"])
